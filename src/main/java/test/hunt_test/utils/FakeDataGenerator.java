...
public class FakeDataGenerator {
    ...
    private List<String> generateUniqueNames(int count) {
        try {
            ...
            throw new CustomError("Ошибка при генерации имен", HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    private List<Application> generateUniqueApplications(int count, int namesCount) {
        try {
            ...
            throw new CustomError("Ошибка при генерации заявок", HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    private List<ApplicationResource> generateFakeApplicationResources(List<Resource> resources, List<Application> applications, int count) {
        try {
            ...
            throw new CustomError("Ошибка при генерации связей заявка-ресурс", HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    private List<Resource> generateUniqueResources(int count) {
        try {
            ...
            throw new CustomError("Ошибка при генерации уникальных ресурсов", HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
    ...
    public FakeStorageDTO generateFakeData(int applicationsCount, int namesCount, int resourcesCount, int applicationResourcesCount) {
        try {
            ...
            throw new CustomError("Ошибка генерации данных", HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
